...
<section class="home-section">
  ...
  <div class="home-showcase">
    <figure class="home-showcase__figure">
      <img src={withBase("/ui-render.png")} alt="Scribdown 渲染样张：标题、列表、代码块、表格、图片与图表" />
    </figure>
...
<section class="home-section">
  <div class="home-cta">
    ...
    <div class="home-cta__actions">
      <a class="home-cta__btn home-cta__btn--brand" href="./guide/quick-start.html">快速上手 →</a>
      <a class="home-cta__btn home-cta__btn--alt" href="./ui-design/overview.html">了解设计体系</a>
    </div>
  </div>
</section>
