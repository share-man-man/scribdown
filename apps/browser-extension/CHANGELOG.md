...
- 02323d5: 按 URL 协议拆分 content script，http(s) 页面的注入脚本从 7.70MB 降至 6.1KB。
...
- Updated dependencies [d8dca11]
  - @scribdown/ui-handdrawn@0.3.3
  - @scribdown/markdown-renderer@0.6.5

## 0.4.4

### Patch Changes

- Updated dependencies [b472972]
  - @scribdown/markdown-renderer@0.6.4
  - @scribdown/shared@0.5.2
  - @scribdown/ui-handdrawn@0.3.2
